...
create table NDP3.ProgrammeKeyResultYearlyReturns
(
	ProgrammeKeyResultYearlyReturnID int identity,
	YearName nchar(7),
	YearStart int,
	YearEnd int,
	Weight decimal (14,4),
	...
	constraint PK_ProgrammeKeyResultYearlyReturns primary key (ProgrammeKeyResultYearlyReturnID),
	constraint FK_ProgrammeKeyResultYearlyReturns_ProgrammeKeyResults foreign key (ProgrammeKeyResultID) references NDP3.ProgrammeKeyResults (ProgrammeKeyResultID)
);
go
...
insert NDP3.ProgrammeKeyResultYearlyReturns (YearName, YearStart, YearEnd, Weight, Target, ProgrammeKeyResultID) values
...
go
 ...
 create view NDP3.vProgrammeKeyResultYearlyReturns as
 select
 	ProgrammeKeyResultYearlyReturnID	[PKRYR ID],
	YearName							[PKRYR Year Name],
	YearStart							[PKRYR Year Start],
	YearEnd								[PKRYR Year End],
	Weight								[PKRYR Weight],
	Actual								[PKRYR Actual],
	Target								[PKRYR Target],
	Performance							[PKRYR Performance],
	WeightedPerformance					[PKRYR Weighted Performance],
	ProgrammeKeyResultID				[PKR ID]
 from NDP3.ProgrammeKeyResultYearlyReturns;
 go

 --select
	--*
 --from NDP3.vProgrammeKeyResultYearlyReturns;
 --go
