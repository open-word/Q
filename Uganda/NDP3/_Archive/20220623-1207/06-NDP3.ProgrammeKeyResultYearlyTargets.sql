...
go
 ...
 drop view if exists NDP3.vProgrammeKeyResultYearlyTargets; 
 go

drop table if exists NDP3.ProgrammeKeyResultYearlyTargets; 
go

create table NDP3.ProgrammeKeyResultYearlyTargets
(
	ProgrammeKeyResultYearlyTargetID int identity,
	YearName nchar(7),
	YearStart int,
	YearEnd int,
	Weight decimal (14,4),
	...
	constraint PK_ProgrammeKeyResultYearlyTargets primary key (ProgrammeKeyResultYearlyTargetID),
	constraint FK_ProgrammeKeyResultYearlyTargets_ProgrammeKeyResults foreign key (ProgrammeKeyResultID) references NDP3.ProgrammeKeyResults (ProgrammeKeyResultID)
);
go
...
insert NDP3.ProgrammeKeyResultYearlyTargets (YearName, YearStart, YearEnd, Weight, Target, ProgrammeKeyResultID) values
...
go
 ...
 create view NDP3.vProgrammeKeyResultYearlyTargets as
 select
 	ProgrammeKeyResultYearlyTargetID	[PKRYT ID],
	YearName							[PKRYT Year Name],
	YearStart							[PKRYT Year Start],
	YearEnd								[PKRYT Year End],
	Weight								[PKRYT Weight],
	Actual								[PKRYT Actual],
	Target								[PKRYT Target],
	Performance							[PKRYT Performance],
	WeightedPerformance					[PKRYT Weighted Performance],
	ProgrammeKeyResultID				[PKR ID]
 from NDP3.ProgrammeKeyResultYearlyTargets;
 go

 --select
	--*
 --from NDP3.vProgrammeKeyResultYearlyTargets;
 --go
