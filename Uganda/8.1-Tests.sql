...
select @IndicatorCheck = count(1) from
	(select distinct ProgrammeID, NDP3Reference from P) a full outer join
	(select distinct substring(I.NDP3Reference,1,2) ProgrammeNDP3Reference, IndicatorID from I) b on a.NDP3Reference = b.ProgrammeNDP3Reference full outer join
