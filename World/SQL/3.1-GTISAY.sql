...
(
	...
	AreaCode int,
	YearCode nchar(4),
	constraint PK_GTISAY primary key (GoalCode, TargetCode, IndicatorCode, SeriesCode, AreaCode, YearCode)
);

insert GTISAY (GoalCode, TargetCode, IndicatorCode, SeriesCode, AreaCode, YearCode)
select
	G.Code,
	T.Code,
	I.Code,
