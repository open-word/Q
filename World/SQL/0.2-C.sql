...
(
	...
	Name nvarchar(52),
	Code int,
	CodeISOAlpha3 nchar(3)
	constraint PK_C primary key (CountryID),
	constraint UQ_C_Name unique (Name),
	constraint UQ_C_Code unique (Code),
	constraint UQ_C_CodeISOAlpha3 unique (CodeISOAlpha3)
);
go

insert C (Name, Code, CodeISOAlpha3) values
('Afghanistan',4  ,'AFG'),
('Åland Islands',248,'ALA'),
('Albania',8  ,'ALB'),
('Algeria',12 ,'DZA'),
('American Samoa',16 ,'ASM'),
('Andorra',20 ,'AND'),
('Angola',24 ,'AGO'),
('Anguilla',660,'AIA'),
('Antarctica',10 ,'ATA'),
...
('Botswana',72 ,'BWA'),
('Bouvet Island',74 ,'BVT'),
('Brazil',76 ,'BRA'),
('British Indian Ocean Territory',86 ,'IOT'),
('British Virgin Islands',92 ,'VGB'),
