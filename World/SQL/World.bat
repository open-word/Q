...
sqlcmd -i %~dp0\dbo\2.5-FGTISP.sql
sqlcmd -i %~dp0\dbo\2.6-FGTISPY.sql
sqlcmd -i %~dp0\dbo\3.1-R.sql
sqlcmd -i %~dp0\dbo\4.1-FGTISPY.sql
sqlcmd -i %~dp0\dbo\5.1-Tests.sql
PAUSE